package com.iqb.eatep.crm.base;
...
public enum CrmReturnInfo implements IReturnInfo {
    ...
    /** crm渠道相关  **/
    CRM_CUSTOMER_CHANNEL_01060001("crm_01060001", "传入客户编码为空", "请选择渠道"),
    CRM_CUSTOMER_CHANNEL_01060002("crm_01060002", "数据已存在", "数据已存在"),
    CRM_CUSTOMER_CHANNEL_01060003("crm_01060003", "传入机构编码为空", "传入机构编码为空");
