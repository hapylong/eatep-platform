package com.iqb.eatep.crm.customer.dao;
...
public interface CustomerDao {
     ...
     * @throws
     * @Author wangxinbang
     * Create Date: 2016年11月9日 下午4:14:28
     */
    public List<Map<String, Object>> getChannelListByOrgCode(Map<String, String> map);

    /**
       @author leiwenyang
       @date : 2016年11月9日 下午9:51:24
     * @param objs
     * @return
     */
    public List<Map<String, Object>> getChannelByOrgCode(JSONObject objs);
