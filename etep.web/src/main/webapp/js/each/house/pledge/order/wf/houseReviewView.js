...
$package('IQB.houseReviewView');
IQB.houseReviewView = function(){
	var _this = {
		cache: {
			dictTypeCode: {
					...
					if(Formatter.extensionName.doc.contain(extensionName)){
						...
						if(n.fileKind > 50){
							var html = '<div class="thumbnail float-left" style="width: 145px;">' + 
							      			'<a href=""><img data-original="' + urls['imgUrl'] + n.filePath + '" alt="' + n.fileName + '" style="width: 135px; height: 135px;"></a>' +
							      			'<div class="caption">' +
							      				'<h5>' + n.fileName + '</h5>' +
							      			'</div>' + 
							      		'</div>';
