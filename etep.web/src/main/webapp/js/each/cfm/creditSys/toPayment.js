...
IQB.toPayment = function(){
	...
	var _this = {
		...
		turnTo : function(rowIndex){
			...
			var orderId=row.orderNo,amount=row.preAmount;
		...
		refresh : function(page){
			...
			_this.cache.t = setInterval(function(){
				$("#datagrid").datagrid2({url: urls['cfm'] + '/business/getPreOrderList',queryParams : $.extend({}, $("#searchForm").serializeObject(), {pageNum: page}),
