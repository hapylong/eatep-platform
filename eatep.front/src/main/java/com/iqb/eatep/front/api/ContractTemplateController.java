...
public class ContractTemplateController extends FrontBaseService {
    ...
    public Object paging(@RequestBody JSONObject objs, HttpServletRequest request) {
        try {
            ...
            PageInfo<ContractTemplateBean> info = this.contractTemplateServiceImpl.selectToListOfBean(contractTemplateBean);
    ...
    public Object insert(@RequestBody JSONObject objs, HttpServletRequest request) {
        try {
            ...
            this.contractTemplateServiceImpl.insert(ContractTemplateServiceImpl.setEcTplContentDataBlob(contractTemplateBean, null));
    ...
    public Object insertWithFile(ContractTemplateBean contractTemplateBean, @RequestParam("file") CommonsMultipartFile file, HttpServletRequest request) {
        try {
            logger.info("合同模板开始添加...");   
            this.contractTemplateServiceImpl.insert(ContractTemplateServiceImpl.setEcTplContentDataBlob(contractTemplateBean, file));
            logger.info("合同模板添加结束.");
            LinkedHashMap<String, Object> linkedHashMap = new LinkedHashMap<String, Object>();
            return super.returnSuccessInfo(linkedHashMap);
        } catch (IqbException iqbe) {
    ...
    public Object update(ContractTemplateBean contractTemplateBean, @RequestParam(value = "file", required = false) CommonsMultipartFile file, HttpServletRequest request) {
        try {
            logger.info("合同模板修改开始...");
            this.contractTemplateServiceImpl.updateByPrimaryKey((ContractTemplateServiceImpl.setEcTplContentDataBlob(contractTemplateBean, file)));
            logger.info("合同模板修改开始.");
            LinkedHashMap<String, Object> linkedHashMap = new LinkedHashMap<String, Object>();
            return super.returnSuccessInfo(linkedHashMap);
        } catch (IqbException iqbe) {
