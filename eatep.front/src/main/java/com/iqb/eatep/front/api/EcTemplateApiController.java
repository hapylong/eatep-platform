package com.iqb.eatep.front.api;
...
public class EcTemplateApiController extends FrontBaseService {
     ...
     * @throws
     * @Author wangxinbang
     * Create Date: 2017年2月21日 下午4:16:55
     */
    @ResponseBody
     ...
     * @throws
     * @Author wangxinbang
     * Create Date: 2017年2月22日 下午5:10:08
     */
    @ResponseBody
     ...
     * @throws
     * @Author wangxinbang
     * Create Date: 2017年2月23日 上午10:30:54
     */
    @ResponseBody
    @RequestMapping(value = "/ssqManualSignNotify", method = { RequestMethod.POST })
    public Object ssqManualSignNotify(HttpServletRequest request){
        try {
            ...
            logger.info("上上签通知接口，传入信息:{}" + JSONObject.toJSONString(objs));
            IThirdEcService thirdEcService = this.thirdEcEntryImpl.getThirdEcService();
            Object obj = thirdEcService.dealSsqManualSignNotify(objs);
            logger.info("上上签通知接口处理完成");
            LinkedHashMap<String, Object> linkedHashMap = new LinkedHashMap<String, Object>();
            linkedHashMap.put("result", obj);
            return super.returnSuccessInfo(linkedHashMap);
        } catch (IqbException iqbe) {
     ...
     * @throws
     * @Author wangxinbang
     * Create Date: 2017年2月23日 下午1:31:53
     */
    @ResponseBody
     ...
     * @throws
     * @Author wangxinbang
     * Create Date: 2017年10月12日 下午4:48:29
     */
    @ResponseBody
    @RequestMapping(value = "/selectContractInfoForDownload", method = { RequestMethod.POST })
    public Object selectContractInfoForDownload(@RequestBody JSONObject objs, HttpServletRequest request) {
        try {
            logger.debug("为合同下载查询合同信息开始，传入信息:{}" + JSONObject.toJSONString(objs));
            Object obj = this.ecInfoServiceImpl.selectContractInfoForDownload(objs);
            logger.info("为合同下载查询合同信息结束");
            LinkedHashMap<String, Object> linkedHashMap = new LinkedHashMap<String, Object>();
            linkedHashMap.put("result", obj);
            return super.returnSuccessInfo(linkedHashMap);
        } catch (IqbException iqbe) {
            logger.error("为合同下载查询合同信息错误信息:" + iqbe.getRetInfo().getRetFactInfo(), iqbe);
            return super.returnFailtrueInfo(iqbe);
        } catch (Exception e) {
            logger.error("为合同下载查询合同信息错误信息:" + CommonReturnInfo.BASE00000001.getRetFactInfo(), e);
            return super.returnFailtrueInfo(new IqbException(CommonReturnInfo.BASE00000001));
        }
    }
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/updateEcDownloadTimes", method = { RequestMethod.POST })
    public Object updateEcDownloadTimes(@RequestBody JSONObject objs, HttpServletRequest request) {
        try {
            logger.debug("更新合同下载次数开始，传入信息:{}" + JSONObject.toJSONString(objs));
            Object obj = this.ecInfoServiceImpl.updateEcDownloadTimes(objs);
            logger.info("更新合同下载次数结束");
            LinkedHashMap<String, Object> linkedHashMap = new LinkedHashMap<String, Object>();
            linkedHashMap.put("result", obj);
            return super.returnSuccessInfo(linkedHashMap);
        } catch (IqbException iqbe) {
            logger.error("更新合同下载次数错误信息:" + iqbe.getRetInfo().getRetFactInfo(), iqbe);
            return super.returnFailtrueInfo(iqbe);
        } catch (Exception e) {
            logger.error("更新合同下载次数错误信息:" + CommonReturnInfo.BASE00000001.getRetFactInfo(), e);
            return super.returnFailtrueInfo(new IqbException(CommonReturnInfo.BASE00000001));
        }
    }
